...
public interface UsuariosCrudFactory extends CrudRepository<Usuarios, String>{
        ...
        @Query("select m.usuariosByUsuariodestino.nombre from Mensajes m where m.usuariosByUsuariosorigen.carne = :idcarne group by m.usuariosByUsuariodestino.carne")
